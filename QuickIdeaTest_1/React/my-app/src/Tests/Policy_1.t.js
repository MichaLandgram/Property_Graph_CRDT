// import { addNode, deleteNode, getVisibleNodes, updateNode, getNodeProps } from '../Version1/V1_idea/SimpleGraph';
import { addNode, deleteNode, getVisibleNodes, updateNode, getNodeProps } from '../Version1/V2_idea/SimpleGraph';
import { syncDocs } from '../Helper/sync';
import { getDoc } from '../Helper/creator';

process.env.test = 'v1_LWWwoE';
...
describe ('Tests for V1', () => {
    describe('(REMOVE_WINS vs. ADD_WINS) NO CONCURRENCY', () => {
        let graph;
        ...
        beforeEach(() => {
            ...
            case 'v1_AWRWwoE':
                ...
                break;
            default:
                throw new Error('No valid test environment variable set for Policy Tests. Look at .env.sample for supported values.');
                }
...
describe('Test for V2 (including concurrent updates)', () => {
        let docA;
        let docB;
        const rwId = 'rw-config-1';
        const awId = 'aw-user-2';
