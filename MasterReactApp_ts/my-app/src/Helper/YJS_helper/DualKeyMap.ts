...
import { GrowOnlyCounter, OurVector, Point } from './moreComplexTypes';
...
export class DualKeyMap {
    ...
    setInitial(key: string, value: any) {
        ...
        // Handle custom objects that need serialization to primitives
    ...
    setUpdate(key: string, value: any, expectedType?: any, graph?: any) {
        // Handle Counter Updates (Special logic preserved)
    ...
    getAll(): any {
        ...
        this.map.forEach((value: any, key: string) => {
             if (key.startsWith('init_')) {
                 ...
                 // Direct value (Update) always wins/overwrites
